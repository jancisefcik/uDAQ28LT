...
# will try to start new MATLAB process from apache2 (using curl).
#
...
# */20 */1 * * * DISPLAY=:0 /home/$USER/Documents/uDAQ28LT/util/udaq_cron.sh
# @reboot export DISPLAY=:0 flock -n /tmp/udaq.lockfile /home/$USER/Documents/uDAQ28LT/util/udaq_cron.sh
# ...and replace $USER with current username.
#
# This supposes that 'udaq_cron.sh' is called from repository, which has been pulled inside
